...
const TextBubble = component('TextBubble', function (props) {
    ...
    if (emotionNo === 0) {
        backgroundClass = 'TextBubble-background u-hidden';
    } else if (emotionNo > 0 && emotionNo < 3) {
        backgroundClass = 'TextBubble-background TextBubble-background--green';
    } else {
        backgroundClass = 'TextBubble-background TextBubble-background--red';
    }

    return (
        <g className="Buyer-textBubble">
            <polygon className={ backgroundClass } points="110 5 110 0 60 0 60 5 55 5 55 35 60 35 60 40 77 40 77 45 82 45 82 50 87 50 87 45 92 45 92 40 110 40 110 35 115 35 115 5 110 5"/>
            { emotion[emotionNo] }
        </g>
    );
});
